...
config.set_section_option(section, "DB_TYPE", env_config("DB_TYPE"))
...
config.set_section_option(section, "DB_ENDPOINT", env_config("DB_ENDPOINT"))
config.set_section_option(section, "DB_PORT", env_config("DB_PORT"))
config.set_section_option(section, "DB_NAME", env_config("DB_NAME"))
config.set_section_option(section, "DB_TABLE", env_config("DB_TABLE"))
