...
async def write_board(request: Request, board_type: BoardType, post_data: BoardCreateIn):
...
@router.get('/board/{board_type}/{board_id}', dependencies=[Depends(oauth2_app)], status_code=HTTP_200_OK)
